            ...
            formElems: [
                {
                    ...
                    subtitle: 'Товар по уже ранее разработанной на производстве рецептуре/технологии, с возможностью изменения упаковки, тары и этикетки под заказчика.',
                },
                {
                    id: 'order2',
                    value: '2',
                    ...
                    subtitle: 'Товар, полностью разрабатываемый под заказчика (рецептура, технология, упаковочная тара, этикетка).',
                },
            ],
        },
    ],
